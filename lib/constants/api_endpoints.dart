class ApiEndpoints {
  ...
  static String usernameList(String role) =>
      '$authBaseURL/rupiya-admin/v1/get_user_name_by_role$apiKey&admin_role=$role';
  static String locationLogs(String salesman, String date) =>
      '$authBaseURL/rupiya-admin/v1/get_user_location_details_by_date$apiKey&user_name=$salesman&select_date=$date';
